...
if [[ $# -ne 4 ]]; then
    echo "Usage: ./3_generate_outputs.sh [--profile-cpu <cpu-profile-output-path>] [--drive-upload <drive-service-account-credentials-url> <drive-upload-dir>] <user> <pipeline-configuration-file-path> <google-cloud-credentials-file-path> <data-root>"
